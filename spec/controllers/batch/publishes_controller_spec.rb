...
describe Batch::PublishesController do
  let(:batch_publish) { create(:batch_publish) }
    ...
    describe "POST 'create'" do
      ...
      context "happy path" do
        ...
        it 'creates a batch' do
          ...
          expect(assigns[:batch]).to be_kind_of BatchPublish
      ...
      context "with duplicate pids" do
        ...
        it "creates a batch with just the unique pids" do
          expect(BatchPublish).to receive(:new).with(pids: pids.uniq) { mock_model(BatchPublish) }
      ...
      context 'error path - no pids were selected:' do
        let(:attrs) { attributes_for(BatchPublish, pids: []) }
        ...
        context "with a referrer" do
          ...
          it 'redirects to previous page' do
            ...
            post :create, batch_publish: attrs
      ...
      context "error path - service fault" do
        ...
        it "redirects to previous page" do
          allow_any_instance_of(BatchPublish).to receive(:save) { true }
